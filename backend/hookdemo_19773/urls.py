"""hookdemo_19773 URL Configuration
...
admin.site.site_header = "hookdemo"
admin.site.site_title = "hookdemo Admin Portal"
admin.site.index_title = "hookdemo Admin"

# swagger
api_info = openapi.Info(
    title="hookdemo API",
    default_version="v1",
    description="API documentation for hookdemo App",
)
